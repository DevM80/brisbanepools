...
SECRET_KEY = 'django-insecure-2k&&ip(3hd70tiy41d$ktka@^*5t^%88f!onk!z=0gtd_&9(up'
...
# Adicione estas linhas se você quiser especificar uma pasta onde os arquivos estáticos serão coletados
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Diretórios adicionais onde os arquivos estáticos são procurados
STATICFILES_DIRS = [
...
EMAIL_HOST_PASSWORD = "vwro otbk ncnw fzkq"
EMAIL_USE_TLS = True
